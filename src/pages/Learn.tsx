...
import { BookOpen, CheckCircle, Bot, TrendingUp, ClipboardCheck } from 'lucide-react';
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 gap-3 mt-6">
        <a href="/quiz" className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-all block text-left">
        ...
        <a href="/ai-companion" className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-all text-left block">
          <div className="w-10 h-10 rounded-xl bg-purple-50 flex items-center justify-center mb-3">
            <Bot size={20} className="text-purple-500" />
          </div>
          <p className="font-medium text-gray-900">AI学伴</p>
          <p className="text-xs text-gray-400 mt-0.5">智能发音陪练</p>
        </a>
      </div>
    </div>
  );
